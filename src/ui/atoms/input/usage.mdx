...
import {ButtonIcon, Input, Button} from 'ui';
import {IconInfo, IconSearch} from 'static/icons';
...
Primary and secondary variants should be used to focus user attention.
