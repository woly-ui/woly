...
<Playground>
  <Checkbox isChecked variant="default" />
  <Checkbox isChecked={false} variant="default" />
</Playground>
...
<Playground>
<<<<<<< HEAD
  <Checkbox text="Attention" variant="error" isChecked/>
  <Checkbox text="Alternative action" variant="secondary" />
  <Checkbox text="Disabled" variant="default" disabled isChecked/>
=======
  <Checkbox text="Attention" variant="error" isChecked disabled />
  <Checkbox text="Alternative action" variant="secondary" isChecked={false} />
  <Checkbox text="Disabled" variant="default" disabled isChecked />
>>>>>>> d28cb32500dc2e033b233bfe088e02c31b68db3a
</Playground>
